...
export const importPrimaryButton =
  "ui-press h-11 cursor-pointer rounded-xl bg-white px-5 text-sm font-semibold tracking-wide text-black transition-colors hover:bg-white/90 disabled:cursor-not-allowed disabled:bg-white/15 disabled:text-white/36";
...
export const importHelperClass = "text-[11px] text-white/45";
...
export const importGroupHeadingClass = "text-[11px] font-semibold uppercase tracking-wide text-white/45";
