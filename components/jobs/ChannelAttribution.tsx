...
export default function ChannelAttribution({
  ...
  const baseClass = [
    ...
    href
      ? "inline-flex min-h-6 cursor-pointer items-center underline-offset-2 hover:text-[var(--vt-link-hover,#ffffff)] hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--vt-accent-ring,rgba(255,255,255,0.2))]"
