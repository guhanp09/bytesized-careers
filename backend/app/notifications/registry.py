...
_EVENTS: tuple[NotificationEvent, ...] = (
    ...
    NotificationEvent(
        ...
        recipient="The other engagement participant",
        actor="Engagement participant",
        channels=(CHANNEL_IN_APP,),
        default_channels=(CHANNEL_IN_APP,),
        priority=PRIORITY_NORMAL,
    ),
    NotificationEvent(
        key="engagement_started",
        category=CATEGORY_LIFECYCLE,
        recipient="The participant who requested the start",
        actor="The confirming participant",
        channels=(CHANNEL_IN_APP,),
        default_channels=(CHANNEL_IN_APP,),
    ),
    NotificationEvent(
        key="engagement_cancelled",
        category=CATEGORY_LIFECYCLE,
        recipient="The other engagement participant",
        actor="Engagement participant",
        channels=(CHANNEL_IN_APP,),
    ...
    NotificationEvent(
        key="engagement_completion_requested",
        category=CATEGORY_LIFECYCLE,
        recipient="The other engagement participant",
        actor="Engagement participant",
        channels=(CHANNEL_IN_APP,),
    ...
    NotificationEvent(
        key="engagement_completion_needs_attention",
        category=CATEGORY_LIFECYCLE,
        recipient="The participant who requested completion",
        actor="The responding participant",
        channels=(CHANNEL_IN_APP,),
        default_channels=(CHANNEL_IN_APP,),
        priority=PRIORITY_NORMAL,
    ),
    NotificationEvent(
        key="engagement_completed",
        category=CATEGORY_LIFECYCLE,
        recipient="Both engagement participants",
        actor="The confirming participant or system",
        channels=(CHANNEL_IN_APP,),
        default_channels=(CHANNEL_IN_APP,),
        priority=PRIORITY_NORMAL,
    ),
    ...
    NotificationEvent(
        key="review_window_expiring",
        category=CATEGORY_LIFECYCLE,
        recipient="An eligible participant who has not reviewed",
        actor=None,
        channels=(CHANNEL_IN_APP,),
        default_channels=(CHANNEL_IN_APP,),
        priority=PRIORITY_LOW,
